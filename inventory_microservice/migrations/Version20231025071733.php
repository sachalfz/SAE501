 ...
 */
final class Version20231025071733 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE inventory (id INT AUTO_INCREMENT NOT NULL, profile_picture VARCHAR(255) NOT NULL, streamz INT NOT NULL, items LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', games_won INT NOT NULL, games_played INT NOT NULL, id_user INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
